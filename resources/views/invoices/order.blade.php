...
<body>
    ...
    <table class="header">
        <tr>
            ...
            <td class="text-right">
                <h3 style="margin: 0 0 5px 0;">Aura Commerce</h3>
    ...
    @php
        ...
        $grandTotal = $order->total_amount ?? ($calculatedSubtotal + $shippingCost);
    @endphp
    ...
    <div class="total-wrapper">
        <div class="total-box">
            <table class="items-table">
                <tr>
                    <th style="background-color: #f3f4f6;">Subtotal Produk</th>
                    <td class="text-right">Rp {{ number_format($calculatedSubtotal, 0, ',', '.') }}</td>
                </tr>
                <tr>
                    <th style="background-color: #f3f4f6;">Ongkos Kirim</th>
                    <td class="text-right">Rp {{ number_format($shippingCost, 0, ',', '.') }}</td>
                </tr>
                <tr>
                    <th style="background-color: #f3f4f6;">Grand Total</th>
                    <td class="text-right">
